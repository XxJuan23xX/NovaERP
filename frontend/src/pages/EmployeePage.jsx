  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-slate-900 border border-slate-850 rounded-2xl p-8 max-w-2xl mx-auto text-center shadow-xl">
          ...
          <div className="border border-slate-800 bg-slate-950 rounded-xl p-5 mb-8 text-left space-y-3">
            ...
            <div className="grid grid-cols-1 gap-2.5">
              <Link 
                ...
                className="flex items-center justify-between p-3 rounded-lg bg-slate-900 hover:bg-slate-850 border border-slate-800 text-indigo-400 hover:text-indigo-300 transition-all font-semibold"
              >
